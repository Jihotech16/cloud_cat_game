...
local src=Image{fromFile="resources/cloud-sheets/thunder/source.png"}
...
local durations={2,0.4,0.13,0.33}
for f=0,3 do
...
sheet:saveAs("assets/cloud-thunder-sheet.png")
anim:saveAs("resources/cloud-sheets/thunder/animation.aseprite")
print("Thunder frame dimensions: 128 x "..height)

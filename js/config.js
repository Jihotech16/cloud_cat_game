...
export const GRAVITY = 0.42 * GAME_SCALE;
export const JUMP_FORCE = 11.5 * GAME_SCALE;
export const CHARGE_RATE = 0.028;
...
export const PLAYER_BASE_SPEED = 4.2 * GAME_SCALE;

export const CLOUD_DISPLAY_WIDTH = Math.round(109 * CLOUD_SCALE);
export const CLOUD_MOVE_SPEED = 1.2 * GAME_SCALE;
